...
class XunfeiAsrService {
  ...
  // WebSocket 连接地址（大模型版）
  static const String _baseUrl = 'wss://office-api-ast-dx.iflyaisol.com/ast/communicate/v1';
  ...
  String _generateAuthUrl() {
    ...
    final utc = '${_formatDateTime(now)}${offsetHours >= 0 ? '+' : ''}${offsetHours.toString().padLeft(2, '0')}${offsetMinutes.abs().toString().padLeft(2, '0')}';
